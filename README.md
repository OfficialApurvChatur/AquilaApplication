...
Elevating Success Together

A proficient organization specializing in developing bespoke web applications for clients with Beehive Corporation.

## Frontend Installation
- Open the terminal in any preferred location, create a folder name `AquilaApplication`, and move inside with the following command.
```
mkdir AquilaApplication
```
```
cd AquilaApplication
```
...
```
git clone https://github.com/ApurvChatur/AquilaApplication.git
```
...
- Kindly, check the documentation properly and ensure you are setting up the backend for `AquilaApplication`.

## Administration Installation
- Please ensure you have set up the backend for `AquilaApplication`, before setting up the admin.
...
- Kindly, check the documentation properly and ensure you are setting up the administration for `AquilaApplication`.