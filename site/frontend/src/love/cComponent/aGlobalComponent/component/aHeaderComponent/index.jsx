...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#F2AA4C]/60 dark:supports-[backdrop-filter]:bg-[#101820]/60 text-[#101820] dark:text-[#F2AA4C]">
