    ...
    <>
      <Card 
        className={`
          ...
          bg-[#F2AA4C] dark:bg-[#101820]
          border-[#101820] dark:border-[#F2AA4C]
          text-[#101820] dark:text-[#F2AA4C]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#101820] dark:border-[#F2AA4C]">
        ...
        <CardFooter className="py-2 border-y border-[#101820] dark:border-[#F2AA4C] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#101820] dark:border-[#F2AA4C]"
              autoComplete="off"
              value={input}
