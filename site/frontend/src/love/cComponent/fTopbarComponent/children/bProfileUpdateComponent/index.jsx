          ...
          <div className="lg:w-4/6 mx-auto">
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#101820] dark:bg-[#F2AA4C] text-[#F2AA4C] dark:text-[#101820]">
                ...
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <div className="w-12 h-1 bg-[#101820] dark:bg-[#F2AA4C] rounded mt-2 mb-4"></div>
                  <p className="text-base">{Redux.state.ReceivedObject?.Retrieve?.subtitle}</p>
                </div>
              </div>
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#101820] dark:border-[#F2AA4C] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p className="leading-relaxed text-lg mb-4">{Redux.state.ReceivedObject?.Retrieve?.description}</p>
              </div>
            </div>
          </div>
        </div>
        <Separator className="bg-[#101820] dark:bg-[#F2AA4C]" />
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-wrap -m-4">

            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#101820] dark:border-[#F2AA4C] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#101820] dark:border-[#F2AA4C] leading-none">Critical Information</h1>
                    ...
                    <div className='mb-2 mt-1 flex flex-1 space-x-4 items-center'>
                      <p>
                        <Avatar>
                          ...
                          <AvatarFallback className="bg-[#101820] dark:bg-[#F2AA4C] text-[#F2AA4C] dark:text-[#101820]">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-[#F2AA4C] dark:bg-[#101820] bg-opacity-40 rounded border 
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#101820] dark:border-[#F2AA4C] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#101820] dark:border-[#F2AA4C] leading-none">Basic Information</h1>
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#101820] dark:border-[#F2AA4C] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#101820] dark:border-[#F2AA4C] leading-none">More Information</h1>

                <div className="w-full mb-2">
                  <div className="relative">
                    <label className="leading-7 text-sm">Address</label>
                    <input 
                      className="mb-2 w-full bg-[#F2AA4C] dark:bg-[#101820] bg-opacity-40 rounded border 
                        border-[#101820] dark:border-[#F2AA4C]
                        focus:border-[#F2AA4C] dark:focus:border-[#101820] 
                        focus:bg-[#101820] dark:focus:bg-[#F2AA4C] 
                        focus:text-[#F2AA4C] dark:focus:text-[#101820] 
