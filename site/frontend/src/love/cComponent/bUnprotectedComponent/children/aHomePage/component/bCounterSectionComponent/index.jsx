              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#101820] dark:bg-[#F2AA4C] text-[#F2AA4C] dark:text-[#101820] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#F2AA4C] dark:bg-[#101820] text-[#101820] dark:text-[#F2AA4C] flex-shrink-0">
