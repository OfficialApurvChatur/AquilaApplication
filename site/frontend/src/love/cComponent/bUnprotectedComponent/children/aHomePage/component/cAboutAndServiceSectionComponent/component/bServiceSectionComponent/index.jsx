              ...
              return (
                <React.Fragment key={index} >
                  <div className="p-4 md:w-1/2">
                    <div className="flex rounded-lg h-full bg-[#101820] dark:bg-[#F2AA4C] text-[#F2AA4C] dark:text-[#101820] bg-opacity-60 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-[#F2AA4C] dark:bg-[#101820] text-[#101820] dark:text-[#F2AA4C] flex-shrink-0">
